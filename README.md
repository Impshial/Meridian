...
The initial surface is **2 km × 2 km**, made from four connected 1 km Unity Terrains with 513 × 513 heights each. Terrain, water, trees, rocks and resource deposits derive from the selected geography and stable logical coordinates. Readiness requires at least 90,000 m² of connected gentle ground, a 200 m interior and a valid full landing/deployment footprint. Narrow or unsuitable regions recover to the planet without reseeding.

Surface controls: WASD/arrows pan, wheel zooms, middle-drag orbits, Home resets, left-click locks a valid site, R/Shift+R changes heading, right-click/Esc clears. Confirmation retains the marker and survey controls; dropship arrival and colony simulation come later. Settings: `Assets/_Meridian/Settings/SurfaceGeneration.asset`. Authoring: `Meridian > Author Landing Site Selection`.
