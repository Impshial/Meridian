...
This first milestone contains the Unity project foundation and startup main menu only. **NEW COLONY, LOAD COLONY, SETTINGS, and QUIT are intentionally inert.** Pointer focus, arrow-key navigation, and press feedback change presentation only; even QUIT leaves the application running. No gameplay systems are implemented.
...
- Target: **Windows desktop, x86-64**. The menu is the only included build scene.
