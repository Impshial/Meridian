...
The initial surface is **2 km × 2 km**, made from four connected 1 km Unity Terrains with 513 × 513 heights each. Surface generator version 2 adds broad hills and shelves, a raised colony plateau, and clustered timber groves while preserving the selected geography and stable logical coordinates. Trees carry stable IDs and wood amounts; grove totals describe available generated members. Readiness requires at least 90,000 m² of connected gentle ground, a 200 m interior and a valid full landing/deployment footprint. Narrow or unsuitable regions recover to the planet without reseeding.
